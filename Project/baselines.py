...
def train(args):
    ...
    x_traindev, y_traindev = data_train["Review"].to_numpy(), data_train["Rating"].to_numpy()
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--train_file', help='Trained file', default="../content/tripadvisor_hotel_reviews_training.csv", type=str)
    
    argparser.add_argument('--dev_file', help='Developed file', default="../content/tripadvisor_hotel_reviews_test.csv", type=str)
    
    argparser.add_argument('--test_file', help='Tested file', default="../content/tripadvisor_hotel_reviews_test.csv", type=str)
    ...
    argparser.add_argument('--model_dir', help='Model dir', default="../content", type=str)
